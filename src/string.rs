...
bitflags! {
  ...
  pub struct WriteFlags: int {
    const kNullTerminate = crate::binding::WriteFlags__bindgen_ty_1::kNullTerminate as _;
    const kReplaceInvalidUtf8 = crate::binding::WriteFlags__bindgen_ty_1::kReplaceInvalidUtf8 as _;
  }
}
