...
impl Object {
  ...
  #[inline(always)]
  pub fn new<'s, 'a>(scope: &'s HandleScope<'a>) -> Local<'s, Object> {
...
impl Map {
  #[inline(always)]
  pub fn new<'s, 'a>(scope: &'s HandleScope<'a>) -> Local<'s, Map> {
...
impl Set {
  #[inline(always)]
  pub fn new<'s, 'a>(scope: &'s HandleScope<'a>) -> Local<'s, Set> {
