...
mod partial_eq_compare {
  use super::*;

  #[inline(always)]
  pub fn same_identity<A, B>(a: &A, b: &B) -> bool
  where
    A: V8HeapObject,
    B: V8HeapObject,
  {
    unsafe {
      let a = a as *const A as *const usize;
      let b = b as *const B as *const usize;
      *a == *b
    }
  }

  #[inline(always)]
  pub fn strict_equals(a: Local<Value>, b: Local<Value>) -> bool {
    a.strict_equals(b)
  }

  #[inline(always)]
  pub fn same_value_zero(a: Local<Value>, b: Local<Value>) -> bool {
    a.same_value_zero(b)
  }
}

macro_rules! impl_partial_eq {
  { $rhs:ident for $lhs:ident use $method:ident } => {
    impl_partial_eq! { type, $rhs, $lhs, $method }
  };
  { type, $lhs:ty, $rhs:ty, $method:ident } => {
    impl_partial_eq! { ref, $lhs, $rhs, $method }
    impl_partial_eq! { ref, Global<$lhs>, $rhs, $method }
    impl_partial_eq! { ref, $lhs, Global<$rhs>, $method }
    impl_partial_eq! { ref, Global<$lhs>, Global<$rhs>, $method }
  };
  { ref, $lhs:ty, $rhs:ty, $method:ident } => {
    impl_partial_eq! { impl, $lhs, $rhs, $method }
    impl_partial_eq! { impl, &$lhs, $rhs, $method }
    impl_partial_eq! { impl, $lhs, &$rhs, $method }
  };
  { impl, $lhs:ty, $rhs:ty, $method:ident } => {
    impl PartialEq<$rhs> for $lhs {
      #[inline(always)]
      fn eq(&self, other: &$rhs) -> bool {
        let h1 = self.get_handle_info();
        let h2 = other.get_handle_info();
        h1.host.assert_match_host(h2.host, None);

        let v1 = unsafe { h1.data.as_ref() };
        let v2 = unsafe { h2.data.as_ref() };
        partial_eq_compare::$method(&*v1, &*v2)
      }
    }
  };
}
...
impl_partial_eq! { AccessorSignature for Data use same_identity }
impl_partial_eq! { Context for Data use same_identity }
impl_partial_eq! { FixedArray for Data use same_identity }
impl_partial_eq! { Module for Data use same_identity }
impl_partial_eq! { ModuleRequest for Data use same_identity }
impl_partial_eq! { PrimitiveArray for Data use same_identity }
impl_partial_eq! { Private for Data use same_identity }
impl_partial_eq! { Signature for Data use same_identity }
impl_partial_eq! { Template for Data use same_identity }
impl_partial_eq! { FunctionTemplate for Data use same_identity }
impl_partial_eq! { ObjectTemplate for Data use same_identity }
impl_partial_eq! { UnboundModuleScript for Data use same_identity }
impl_partial_eq! { External for Data use same_identity }
impl_partial_eq! { Object for Data use same_identity }
impl_partial_eq! { Array for Data use same_identity }
impl_partial_eq! { ArrayBuffer for Data use same_identity }
impl_partial_eq! { ArrayBufferView for Data use same_identity }
impl_partial_eq! { DataView for Data use same_identity }
impl_partial_eq! { TypedArray for Data use same_identity }
impl_partial_eq! { BigInt64Array for Data use same_identity }
impl_partial_eq! { BigUint64Array for Data use same_identity }
impl_partial_eq! { Float32Array for Data use same_identity }
impl_partial_eq! { Float64Array for Data use same_identity }
impl_partial_eq! { Int16Array for Data use same_identity }
impl_partial_eq! { Int32Array for Data use same_identity }
impl_partial_eq! { Int8Array for Data use same_identity }
impl_partial_eq! { Uint16Array for Data use same_identity }
impl_partial_eq! { Uint32Array for Data use same_identity }
impl_partial_eq! { Uint8Array for Data use same_identity }
impl_partial_eq! { Uint8ClampedArray for Data use same_identity }
impl_partial_eq! { BigIntObject for Data use same_identity }
impl_partial_eq! { BooleanObject for Data use same_identity }
impl_partial_eq! { Date for Data use same_identity }
impl_partial_eq! { Function for Data use same_identity }
impl_partial_eq! { Map for Data use same_identity }
impl_partial_eq! { NumberObject for Data use same_identity }
impl_partial_eq! { Promise for Data use same_identity }
impl_partial_eq! { PromiseResolver for Data use same_identity }
impl_partial_eq! { Proxy for Data use same_identity }
impl_partial_eq! { RegExp for Data use same_identity }
impl_partial_eq! { Set for Data use same_identity }
impl_partial_eq! { SharedArrayBuffer for Data use same_identity }
impl_partial_eq! { StringObject for Data use same_identity }
impl_partial_eq! { SymbolObject for Data use same_identity }
impl_partial_eq! { WasmMemoryObject for Data use same_identity }
impl_partial_eq! { WasmModuleObject for Data use same_identity }
impl_partial_eq! { Boolean for Data use same_identity }
impl_partial_eq! { Symbol for Data use same_identity }
...
impl V8HeapObject for AccessorSignature {}
impl_deref! { Data for AccessorSignature }
impl_eq! { for AccessorSignature }
impl_partial_eq! { Data for AccessorSignature use same_identity }
impl_partial_eq! { AccessorSignature for AccessorSignature use same_identity }
...
impl V8HeapObject for Context {}
impl_deref! { Data for Context }
impl_try_from! { Data for Context if v => v.is_context() }
impl_eq! { for Context }
impl_partial_eq! { Data for Context use same_identity }
impl_partial_eq! { Context for Context use same_identity }
...
impl V8HeapObject for FixedArray {}
impl_deref! { Data for FixedArray }
impl_try_from! { Data for FixedArray if v => v.is_fixed_array() }
impl_eq! { for FixedArray }
impl_partial_eq! { Data for FixedArray use same_identity }
impl_partial_eq! { FixedArray for FixedArray use same_identity }
...
impl V8HeapObject for Message {}
impl_eq! { for Message }
impl_partial_eq! { Message for Message use same_identity }
...
impl V8HeapObject for Module {}
impl_deref! { Data for Module }
impl_try_from! { Data for Module if v => v.is_module() }
impl_eq! { for Module }
impl_hash! { for Module use get_identity_hash }
impl_partial_eq! { Data for Module use same_identity }
impl_partial_eq! { Module for Module use same_identity }

#[repr(C)]
#[derive(Debug)]
pub struct ModuleRequest(Opaque);

impl V8HeapObject for ModuleRequest {}
impl_deref! { Data for ModuleRequest }
impl_try_from! { Data for ModuleRequest if v => v.is_module_request() }
impl_eq! { for ModuleRequest }
impl_partial_eq! { Data for ModuleRequest use same_identity }
impl_partial_eq! { ModuleRequest for ModuleRequest use same_identity }
...
impl V8HeapObject for PrimitiveArray {}
impl_deref! { Data for PrimitiveArray }
impl_eq! { for PrimitiveArray }
impl_partial_eq! { Data for PrimitiveArray use same_identity }
impl_partial_eq! { PrimitiveArray for PrimitiveArray use same_identity }
...
impl V8HeapObject for Private {}
impl_deref! { Data for Private }
impl_try_from! { Data for Private if v => v.is_private() }
impl_eq! { for Private }
impl_partial_eq! { Data for Private use same_identity }
impl_partial_eq! { Private for Private use same_identity }
...
impl V8HeapObject for Script {}
impl_eq! { for Script }
impl_partial_eq! { Script for Script use same_identity }
...
impl V8HeapObject for ScriptOrModule {}
impl_eq! { for ScriptOrModule }
impl_partial_eq! { ScriptOrModule for ScriptOrModule use same_identity }
...
impl V8HeapObject for Signature {}
impl_deref! { Data for Signature }
impl_eq! { for Signature }
impl_partial_eq! { Data for Signature use same_identity }
impl_partial_eq! { Signature for Signature use same_identity }
...
impl V8HeapObject for StackFrame {}
impl_eq! { for StackFrame }
impl_partial_eq! { StackFrame for StackFrame use same_identity }
...
impl V8HeapObject for StackTrace {}
impl_eq! { for StackTrace }
impl_partial_eq! { StackTrace for StackTrace use same_identity }
...
impl V8HeapObject for Template {}
...
impl_partial_eq! { Data for Template use same_identity }
impl_partial_eq! { Template for Template use same_identity }
impl_partial_eq! { FunctionTemplate for Template use same_identity }
impl_partial_eq! { ObjectTemplate for Template use same_identity }
...
impl V8HeapObject for FunctionTemplate {}
...
impl_partial_eq! { Data for FunctionTemplate use same_identity }
impl_partial_eq! { Template for FunctionTemplate use same_identity }
impl_partial_eq! { FunctionTemplate for FunctionTemplate use same_identity }
...
impl V8HeapObject for ObjectTemplate {}
...
impl_partial_eq! { Data for ObjectTemplate use same_identity }
impl_partial_eq! { Template for ObjectTemplate use same_identity }
impl_partial_eq! { ObjectTemplate for ObjectTemplate use same_identity }
...
impl V8HeapObject for UnboundModuleScript {}
impl_deref! { Data for UnboundModuleScript }
impl_eq! { for UnboundModuleScript }
impl_partial_eq! { Data for UnboundModuleScript use same_identity }
impl_partial_eq! { UnboundModuleScript for UnboundModuleScript use same_identity }
...
impl V8HeapObject for UnboundScript {}
impl_eq! { for UnboundScript }
impl_partial_eq! { UnboundScript for UnboundScript use same_identity }
...
impl_partial_eq! { External for Value use same_identity }
impl_partial_eq! { Object for Value use same_identity }
impl_partial_eq! { Array for Value use same_identity }
impl_partial_eq! { ArrayBuffer for Value use same_identity }
impl_partial_eq! { ArrayBufferView for Value use same_identity }
impl_partial_eq! { DataView for Value use same_identity }
impl_partial_eq! { TypedArray for Value use same_identity }
impl_partial_eq! { BigInt64Array for Value use same_identity }
impl_partial_eq! { BigUint64Array for Value use same_identity }
impl_partial_eq! { Float32Array for Value use same_identity }
impl_partial_eq! { Float64Array for Value use same_identity }
impl_partial_eq! { Int16Array for Value use same_identity }
impl_partial_eq! { Int32Array for Value use same_identity }
impl_partial_eq! { Int8Array for Value use same_identity }
impl_partial_eq! { Uint16Array for Value use same_identity }
impl_partial_eq! { Uint32Array for Value use same_identity }
impl_partial_eq! { Uint8Array for Value use same_identity }
impl_partial_eq! { Uint8ClampedArray for Value use same_identity }
impl_partial_eq! { BigIntObject for Value use same_identity }
impl_partial_eq! { BooleanObject for Value use same_identity }
impl_partial_eq! { Date for Value use same_identity }
impl_partial_eq! { Function for Value use same_identity }
impl_partial_eq! { Map for Value use same_identity }
impl_partial_eq! { NumberObject for Value use same_identity }
impl_partial_eq! { Promise for Value use same_identity }
impl_partial_eq! { PromiseResolver for Value use same_identity }
impl_partial_eq! { Proxy for Value use same_identity }
impl_partial_eq! { RegExp for Value use same_identity }
impl_partial_eq! { Set for Value use same_identity }
impl_partial_eq! { SharedArrayBuffer for Value use same_identity }
impl_partial_eq! { StringObject for Value use same_identity }
impl_partial_eq! { SymbolObject for Value use same_identity }
impl_partial_eq! { WasmMemoryObject for Value use same_identity }
impl_partial_eq! { WasmModuleObject for Value use same_identity }
impl_partial_eq! { Primitive for Value use same_value_zero }
impl_partial_eq! { BigInt for Value use same_value_zero }
impl_partial_eq! { Boolean for Value use same_identity }
impl_partial_eq! { Name for Value use same_value_zero }
impl_partial_eq! { String for Value use same_value_zero }
impl_partial_eq! { Symbol for Value use same_identity }
...
impl V8HeapObject for External {}
...
impl_partial_eq! { Data for External use same_identity }
impl_partial_eq! { Value for External use same_identity }
impl_partial_eq! { External for External use same_identity }
...
impl_partial_eq! { Data for Object use same_identity }
impl_partial_eq! { Value for Object use same_identity }
impl_partial_eq! { Object for Object use same_identity }
impl_partial_eq! { Array for Object use same_identity }
impl_partial_eq! { ArrayBuffer for Object use same_identity }
impl_partial_eq! { ArrayBufferView for Object use same_identity }
impl_partial_eq! { DataView for Object use same_identity }
impl_partial_eq! { TypedArray for Object use same_identity }
impl_partial_eq! { BigInt64Array for Object use same_identity }
impl_partial_eq! { BigUint64Array for Object use same_identity }
impl_partial_eq! { Float32Array for Object use same_identity }
impl_partial_eq! { Float64Array for Object use same_identity }
impl_partial_eq! { Int16Array for Object use same_identity }
impl_partial_eq! { Int32Array for Object use same_identity }
impl_partial_eq! { Int8Array for Object use same_identity }
impl_partial_eq! { Uint16Array for Object use same_identity }
impl_partial_eq! { Uint32Array for Object use same_identity }
impl_partial_eq! { Uint8Array for Object use same_identity }
impl_partial_eq! { Uint8ClampedArray for Object use same_identity }
impl_partial_eq! { BigIntObject for Object use same_identity }
impl_partial_eq! { BooleanObject for Object use same_identity }
impl_partial_eq! { Date for Object use same_identity }
impl_partial_eq! { Function for Object use same_identity }
impl_partial_eq! { Map for Object use same_identity }
impl_partial_eq! { NumberObject for Object use same_identity }
impl_partial_eq! { Promise for Object use same_identity }
impl_partial_eq! { PromiseResolver for Object use same_identity }
impl_partial_eq! { Proxy for Object use same_identity }
impl_partial_eq! { RegExp for Object use same_identity }
impl_partial_eq! { Set for Object use same_identity }
impl_partial_eq! { SharedArrayBuffer for Object use same_identity }
impl_partial_eq! { StringObject for Object use same_identity }
impl_partial_eq! { SymbolObject for Object use same_identity }
impl_partial_eq! { WasmMemoryObject for Object use same_identity }
impl_partial_eq! { WasmModuleObject for Object use same_identity }
...
impl_partial_eq! { Data for Array use same_identity }
impl_partial_eq! { Value for Array use same_identity }
impl_partial_eq! { Object for Array use same_identity }
impl_partial_eq! { Array for Array use same_identity }
...
impl V8HeapObject for ArrayBuffer {}
...
impl_partial_eq! { Data for ArrayBuffer use same_identity }
impl_partial_eq! { Value for ArrayBuffer use same_identity }
impl_partial_eq! { Object for ArrayBuffer use same_identity }
impl_partial_eq! { ArrayBuffer for ArrayBuffer use same_identity }
...
impl V8HeapObject for ArrayBufferView {}
...
impl_partial_eq! { Data for ArrayBufferView use same_identity }
impl_partial_eq! { Value for ArrayBufferView use same_identity }
impl_partial_eq! { Object for ArrayBufferView use same_identity }
impl_partial_eq! { ArrayBufferView for ArrayBufferView use same_identity }
impl_partial_eq! { DataView for ArrayBufferView use same_identity }
impl_partial_eq! { TypedArray for ArrayBufferView use same_identity }
impl_partial_eq! { BigInt64Array for ArrayBufferView use same_identity }
impl_partial_eq! { BigUint64Array for ArrayBufferView use same_identity }
impl_partial_eq! { Float32Array for ArrayBufferView use same_identity }
impl_partial_eq! { Float64Array for ArrayBufferView use same_identity }
impl_partial_eq! { Int16Array for ArrayBufferView use same_identity }
impl_partial_eq! { Int32Array for ArrayBufferView use same_identity }
impl_partial_eq! { Int8Array for ArrayBufferView use same_identity }
impl_partial_eq! { Uint16Array for ArrayBufferView use same_identity }
impl_partial_eq! { Uint32Array for ArrayBufferView use same_identity }
impl_partial_eq! { Uint8Array for ArrayBufferView use same_identity }
impl_partial_eq! { Uint8ClampedArray for ArrayBufferView use same_identity }
...
impl V8HeapObject for DataView {}
...
impl_partial_eq! { Data for DataView use same_identity }
impl_partial_eq! { Value for DataView use same_identity }
impl_partial_eq! { Object for DataView use same_identity }
impl_partial_eq! { ArrayBufferView for DataView use same_identity }
impl_partial_eq! { DataView for DataView use same_identity }
...
impl V8HeapObject for TypedArray {}
...
impl_partial_eq! { Data for TypedArray use same_identity }
impl_partial_eq! { Value for TypedArray use same_identity }
impl_partial_eq! { Object for TypedArray use same_identity }
impl_partial_eq! { ArrayBufferView for TypedArray use same_identity }
impl_partial_eq! { TypedArray for TypedArray use same_identity }
impl_partial_eq! { BigInt64Array for TypedArray use same_identity }
impl_partial_eq! { BigUint64Array for TypedArray use same_identity }
impl_partial_eq! { Float32Array for TypedArray use same_identity }
impl_partial_eq! { Float64Array for TypedArray use same_identity }
impl_partial_eq! { Int16Array for TypedArray use same_identity }
impl_partial_eq! { Int32Array for TypedArray use same_identity }
impl_partial_eq! { Int8Array for TypedArray use same_identity }
impl_partial_eq! { Uint16Array for TypedArray use same_identity }
impl_partial_eq! { Uint32Array for TypedArray use same_identity }
impl_partial_eq! { Uint8Array for TypedArray use same_identity }
impl_partial_eq! { Uint8ClampedArray for TypedArray use same_identity }
...
impl V8HeapObject for BigInt64Array {}
...
impl_partial_eq! { Data for BigInt64Array use same_identity }
impl_partial_eq! { Value for BigInt64Array use same_identity }
impl_partial_eq! { Object for BigInt64Array use same_identity }
impl_partial_eq! { ArrayBufferView for BigInt64Array use same_identity }
impl_partial_eq! { TypedArray for BigInt64Array use same_identity }
impl_partial_eq! { BigInt64Array for BigInt64Array use same_identity }
...
impl V8HeapObject for BigUint64Array {}
...
impl_partial_eq! { Data for BigUint64Array use same_identity }
impl_partial_eq! { Value for BigUint64Array use same_identity }
impl_partial_eq! { Object for BigUint64Array use same_identity }
impl_partial_eq! { ArrayBufferView for BigUint64Array use same_identity }
impl_partial_eq! { TypedArray for BigUint64Array use same_identity }
impl_partial_eq! { BigUint64Array for BigUint64Array use same_identity }
...
impl V8HeapObject for Float32Array {}
...
impl_partial_eq! { Data for Float32Array use same_identity }
impl_partial_eq! { Value for Float32Array use same_identity }
impl_partial_eq! { Object for Float32Array use same_identity }
impl_partial_eq! { ArrayBufferView for Float32Array use same_identity }
impl_partial_eq! { TypedArray for Float32Array use same_identity }
impl_partial_eq! { Float32Array for Float32Array use same_identity }
...
impl V8HeapObject for Float64Array {}
...
impl_partial_eq! { Data for Float64Array use same_identity }
impl_partial_eq! { Value for Float64Array use same_identity }
impl_partial_eq! { Object for Float64Array use same_identity }
impl_partial_eq! { ArrayBufferView for Float64Array use same_identity }
impl_partial_eq! { TypedArray for Float64Array use same_identity }
impl_partial_eq! { Float64Array for Float64Array use same_identity }
...
impl V8HeapObject for Int16Array {}
...
impl_partial_eq! { Data for Int16Array use same_identity }
impl_partial_eq! { Value for Int16Array use same_identity }
impl_partial_eq! { Object for Int16Array use same_identity }
impl_partial_eq! { ArrayBufferView for Int16Array use same_identity }
impl_partial_eq! { TypedArray for Int16Array use same_identity }
impl_partial_eq! { Int16Array for Int16Array use same_identity }
...
impl V8HeapObject for Int32Array {}
...
impl_partial_eq! { Data for Int32Array use same_identity }
impl_partial_eq! { Value for Int32Array use same_identity }
impl_partial_eq! { Object for Int32Array use same_identity }
impl_partial_eq! { ArrayBufferView for Int32Array use same_identity }
impl_partial_eq! { TypedArray for Int32Array use same_identity }
impl_partial_eq! { Int32Array for Int32Array use same_identity }
...
impl V8HeapObject for Int8Array {}
...
impl_partial_eq! { Data for Int8Array use same_identity }
impl_partial_eq! { Value for Int8Array use same_identity }
impl_partial_eq! { Object for Int8Array use same_identity }
impl_partial_eq! { ArrayBufferView for Int8Array use same_identity }
impl_partial_eq! { TypedArray for Int8Array use same_identity }
impl_partial_eq! { Int8Array for Int8Array use same_identity }
...
impl V8HeapObject for Uint16Array {}
...
impl_partial_eq! { Data for Uint16Array use same_identity }
impl_partial_eq! { Value for Uint16Array use same_identity }
impl_partial_eq! { Object for Uint16Array use same_identity }
impl_partial_eq! { ArrayBufferView for Uint16Array use same_identity }
impl_partial_eq! { TypedArray for Uint16Array use same_identity }
impl_partial_eq! { Uint16Array for Uint16Array use same_identity }
...
impl V8HeapObject for Uint32Array {}
...
impl_partial_eq! { Data for Uint32Array use same_identity }
impl_partial_eq! { Value for Uint32Array use same_identity }
impl_partial_eq! { Object for Uint32Array use same_identity }
impl_partial_eq! { ArrayBufferView for Uint32Array use same_identity }
impl_partial_eq! { TypedArray for Uint32Array use same_identity }
impl_partial_eq! { Uint32Array for Uint32Array use same_identity }
...
impl V8HeapObject for Uint8Array {}
...
impl_partial_eq! { Data for Uint8Array use same_identity }
impl_partial_eq! { Value for Uint8Array use same_identity }
impl_partial_eq! { Object for Uint8Array use same_identity }
impl_partial_eq! { ArrayBufferView for Uint8Array use same_identity }
impl_partial_eq! { TypedArray for Uint8Array use same_identity }
impl_partial_eq! { Uint8Array for Uint8Array use same_identity }
...
impl V8HeapObject for Uint8ClampedArray {}
...
impl_partial_eq! { Data for Uint8ClampedArray use same_identity }
impl_partial_eq! { Value for Uint8ClampedArray use same_identity }
impl_partial_eq! { Object for Uint8ClampedArray use same_identity }
impl_partial_eq! { ArrayBufferView for Uint8ClampedArray use same_identity }
impl_partial_eq! { TypedArray for Uint8ClampedArray use same_identity }
impl_partial_eq! { Uint8ClampedArray for Uint8ClampedArray use same_identity }
...
impl V8HeapObject for BigIntObject {}
...
impl_partial_eq! { Data for BigIntObject use same_identity }
impl_partial_eq! { Value for BigIntObject use same_identity }
impl_partial_eq! { Object for BigIntObject use same_identity }
impl_partial_eq! { BigIntObject for BigIntObject use same_identity }
...
impl V8HeapObject for BooleanObject {}
...
impl_partial_eq! { Data for BooleanObject use same_identity }
impl_partial_eq! { Value for BooleanObject use same_identity }
impl_partial_eq! { Object for BooleanObject use same_identity }
impl_partial_eq! { BooleanObject for BooleanObject use same_identity }
...
impl_partial_eq! { Data for Date use same_identity }
impl_partial_eq! { Value for Date use same_identity }
impl_partial_eq! { Object for Date use same_identity }
impl_partial_eq! { Date for Date use same_identity }
...
impl V8HeapObject for Function {}
...
impl_partial_eq! { Data for Function use same_identity }
impl_partial_eq! { Value for Function use same_identity }
impl_partial_eq! { Object for Function use same_identity }
impl_partial_eq! { Function for Function use same_identity }
...
impl_partial_eq! { Data for Map use same_identity }
impl_partial_eq! { Value for Map use same_identity }
impl_partial_eq! { Object for Map use same_identity }
impl_partial_eq! { Map for Map use same_identity }
...
impl V8HeapObject for NumberObject {}
...
impl_partial_eq! { Data for NumberObject use same_identity }
impl_partial_eq! { Value for NumberObject use same_identity }
impl_partial_eq! { Object for NumberObject use same_identity }
impl_partial_eq! { NumberObject for NumberObject use same_identity }
...
impl_partial_eq! { Data for Promise use same_identity }
impl_partial_eq! { Value for Promise use same_identity }
impl_partial_eq! { Object for Promise use same_identity }
impl_partial_eq! { Promise for Promise use same_identity }

#[repr(C)]
#[derive(Debug)]
pub struct PromiseResolver(Opaque);

impl V8HeapObject for PromiseResolver {}
impl_deref! { Object for PromiseResolver }
impl_eq! { for PromiseResolver }
impl_hash! { for PromiseResolver use get_identity_hash }
impl_partial_eq! { Data for PromiseResolver use same_identity }
impl_partial_eq! { Value for PromiseResolver use same_identity }
impl_partial_eq! { Object for PromiseResolver use same_identity }
impl_partial_eq! { PromiseResolver for PromiseResolver use same_identity }
...
impl_partial_eq! { Data for Proxy use same_identity }
impl_partial_eq! { Value for Proxy use same_identity }
impl_partial_eq! { Object for Proxy use same_identity }
impl_partial_eq! { Proxy for Proxy use same_identity }
...
impl_partial_eq! { Data for RegExp use same_identity }
impl_partial_eq! { Value for RegExp use same_identity }
impl_partial_eq! { Object for RegExp use same_identity }
impl_partial_eq! { RegExp for RegExp use same_identity }
...
impl_partial_eq! { Data for Set use same_identity }
impl_partial_eq! { Value for Set use same_identity }
impl_partial_eq! { Object for Set use same_identity }
impl_partial_eq! { Set for Set use same_identity }
...
impl V8HeapObject for SharedArrayBuffer {}
...
impl_partial_eq! { Data for SharedArrayBuffer use same_identity }
impl_partial_eq! { Value for SharedArrayBuffer use same_identity }
impl_partial_eq! { Object for SharedArrayBuffer use same_identity }
impl_partial_eq! { SharedArrayBuffer for SharedArrayBuffer use same_identity }
...
impl V8HeapObject for StringObject {}
...
impl_partial_eq! { Data for StringObject use same_identity }
impl_partial_eq! { Value for StringObject use same_identity }
impl_partial_eq! { Object for StringObject use same_identity }
impl_partial_eq! { StringObject for StringObject use same_identity }
...
impl V8HeapObject for SymbolObject {}
...
impl_partial_eq! { Data for SymbolObject use same_identity }
impl_partial_eq! { Value for SymbolObject use same_identity }
impl_partial_eq! { Object for SymbolObject use same_identity }
impl_partial_eq! { SymbolObject for SymbolObject use same_identity }

#[repr(C)]
#[derive(Debug)]
pub struct WasmMemoryObject(Opaque);

impl V8HeapObject for WasmMemoryObject {}
...
impl_partial_eq! { Data for WasmMemoryObject use same_identity }
impl_partial_eq! { Value for WasmMemoryObject use same_identity }
impl_partial_eq! { Object for WasmMemoryObject use same_identity }
impl_partial_eq! { WasmMemoryObject for WasmMemoryObject use same_identity }

#[repr(C)]
#[derive(Debug)]
pub struct WasmModuleObject(Opaque);

impl V8HeapObject for WasmModuleObject {}
...
impl_partial_eq! { Data for WasmModuleObject use same_identity }
impl_partial_eq! { Value for WasmModuleObject use same_identity }
impl_partial_eq! { Object for WasmModuleObject use same_identity }
impl_partial_eq! { WasmModuleObject for WasmModuleObject use same_identity }
...
impl V8HeapObject for Primitive {}
...
impl_partial_eq! { Data for Boolean use same_identity }
impl_partial_eq! { Value for Boolean use same_identity }
impl_partial_eq! { Primitive for Boolean use same_identity }
impl_partial_eq! { Boolean for Boolean use same_identity }
...
impl_partial_eq! { Symbol for Name use same_identity }
...
impl_partial_eq! { Data for Symbol use same_identity }
impl_partial_eq! { Value for Symbol use same_identity }
impl_partial_eq! { Primitive for Symbol use same_identity }
impl_partial_eq! { Name for Symbol use same_identity }
impl_partial_eq! { Symbol for Symbol use same_identity }
